...
This page describes the pipeline for the ABBA BABA tests (D statistics) testing for gene flow between populations. 

For this analysis, we need a dataset of high quality SNPs, and we need an outgroup.  
We will use *Ceratopipra erythrocephala* as our outgroup in the P4 position. An alternative would be to use the reference genome (*Pipra filicauda*) as the outgroup, but it is a bit distant; in general it is best to choose a P4 that is as close as possible to your ingroup without having too much incomplete lineage sorting (which would cause noise in interpretting which alleles are derived vs ancestral, i.e., BAAB would be counted as ABBA, and ABAB as BABA).  

We will use the same dataset as for Splitstree: `Ceratopipra_rubrocapilla_imeriout_m07.GBSPipfilbwa.allsites.filtered.genicintergenic.forSVD.49_0.2_5_20.vcf.gz`
...
#try a few different filters to ensure that results are robust to bioinformatic choices. Results qualitatively similar.
...
#repeat with alternate tree treating InambariE sister to the eastern populations
...
#repeat with alternate tree treating headwaters sister to Rondonia
echo "((((((AtlanticForest,XinguBelemC),XinguBelemN),Tapajos),(((TapajosHeadwaters,Headwaters),RondoniaHeadwaters),Rondonia)),(InambariW,InambariE)),Outgroup);" > Ceratopipra.alternate2_10subpops.nwk
time /home/0_PROGRAMS/Dsuite/Build/Dsuite Dtrios "$DATASET".vcf.gz samples_ID_10subpops.txt -t Ceratopipra.alternate2_10subpops.nwk -n "$DATASET".alternate2_10subpops #1m54.835s

```

One note: for trios that have not had population assignments changed between iterations, D, p, and site counts should be the same between iterations. f4 may not be the same because it has a stochastic component (P3 is split into two groups, with alleles assigned randomly) and so while its magnitude should not wildly differ between iterations, its exact value may vary.

For example, compare results for these two iterations where we only changed population assignments in the Atlantic Forest:  
```
P1	P2	P3	Dstatistic	Z-score	p-value	f4-ratio	BBAA	ABBA	BABA

Ceratopipra_rubrocapilla_imeriout_m07.GBSPipfilbwa.allsites.filtered.genicintergenic.forSVD.49_0.2_5_20/samples_ID_10subpops_Ceratopipra_rubrocapilla_imeriout_m07.GBSPipfilbwa.allsites.filtered.genicintergenic.forSVD.49_0.2_5_20.alternate_10subpops_tree.txt
Rondonia	InambariE	InambariW	0.0275483	5.79002	7.04E-09	0.96549	821.593	806.774	763.515
RondoniaHeadwaters	InambariE	InambariW	0.0275967	4.83882	1.31E-06	0.901733	835.239	816.261	772.418
TapajosHeadwaters	InambariE	InambariW	0.0409891	6.86022	6.88E-12	0.957447	715.143	727.749	670.438
Headwaters	InambariE	InambariW	0.0284633	4.94191	7.74E-07	1.08995	829.453	817.656	772.398
Tapajos	InambariE	InambariW	0.0457011	9.19278	0	0.970728	807.477	818.717	747.155
XinguBelemN	InambariE	InambariW	0.052284	10.9153	0	1.02643	773.628	813.25	732.436
XinguBelemC	InambariE	InambariW	0.0550751	9.43072	0	0.941942	792.574	825.28	739.12
AtlanticForest	InambariE	InambariW	0.0568683	11.8932	0	0.953435	798.475	827.498	738.445
									
									
Ceratopipra_rubrocapilla_imeriout_m07.GBSPipfilbwa.allsites.filtered.genicintergenic.forSVD.49_0.2_5_20/samples_ID_Ceratopipra_rubrocapilla_imeriout_m07.GBSPipfilbwa.allsites.filtered.genicintergenic.forSVD.49_0.2_5_20.alternate_tree.txt
Rondonia	InambariE	InambariW	0.0275483	5.79002	7.04E-09	0.826762	821.593	806.774	763.515
RondoniaHeadwaters	InambariE	InambariW	0.0275967	4.83882	1.31E-06	0.786338	835.239	816.261	772.418
Headwaters	InambariE	InambariW	0.0284633	4.94191	7.74E-07	0.832381	829.453	817.656	772.398
TapajosHeadwaters	InambariE	InambariW	0.0409891	6.86022	6.88E-12	0.825498	715.143	727.749	670.438
Tapajos	InambariE	InambariW	0.0457011	9.19278	0.00E+00	0.889498	807.477	818.717	747.155
XinguBelemN	InambariE	InambariW	0.052284	10.9153	0	0.875615	773.628	813.25	732.436
XinguBelemC	InambariE	InambariW	0.0550751	9.43072	0	0.895862	792.574	825.28	739.12
AtlanticForest_Ilheus	InambariE	InambariW	0.0557107	9.23091	0	0.90629	798.206	826.114	738.925
AtlanticForest_Ibateguara	InambariE	InambariW	0.0581051	13.5445	0	0.891753	799.304	829.145	738.082
```


Next, I will split the Tapajos into north and south to check whether those subpopulations hae evidence of differing in any levels of gene flow. These are not really valid population divisions, but am am curious whether the southern samples are more "introgressed" than the northern ones.  
...
```
No, there is no further insight revealed by splitting northern and central Tapajos.
